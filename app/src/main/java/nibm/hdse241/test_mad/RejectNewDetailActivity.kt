...
class RejectNewDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_reject_news_details)
        ...
        btnSubmitReason.setOnClickListener {
            ...
            // Save to Firebase
            if (newsId != null) {
                val rejectRef = database.child("RejectNewsReasons").child(newsId)
